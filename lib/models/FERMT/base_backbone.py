...
from lib.models.FERMT.TSMoE import SelectToken
...
class BaseBackbone(nn.Module):
    def __init__(self):
        ...
        self.topK_back = 4
        self.winSize = 2
        self.TSMoE = SelectToken(dim=self.dim,topk_fore=self.topK_fore,topk_back=self.topK_back,winSize=self.winSize)
